...
VAR MOD1.ls(h) 1 4 dpn dwyp dscpi  dwyws @ C dppi(-1) dppi(-2) dppi(-3) dppi(-4) dy(-1) dy(-2) dy(-3) dy(-4) dgdpd(-1) dgdpd(-2) dgdpd(-3) dgdpd(-4) dum_ms1 dum_ms2 dpnaer(-1) dpnaer(-2) dpnaer(-3) dpnaer(-4) de(-1) de(-2) de(-3) de(-4)
...
VAR MODPOP.ls 1 4 dppop duspop @ dpnms(-1) dpnaer(-1) dpn(-1)

MODEL model_pop

model_pop.merge MODPOP
...
'For forecast period, consider adjusting this submodel to respect downstream PHSE adjustments that reconcile household count with household population (final steps before output)
...
WRITE "Master eView Model\OUT_REVENUE2.xls" pretail_0 kretail_0 bretail_0 tretail_0 sretail_0   pvehic_0 pcar_0 ptrkgas_0 ptrkdies_0 pothveh_0    kvehic_0 bvehic_0 tvehic_0 svehic_0   pmvet_0 kmvet_0 bmvet_0 tmvet_0 smvet_0   wfuel_0
